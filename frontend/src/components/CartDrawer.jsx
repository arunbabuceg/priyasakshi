                ...
                <div className="flex flex-col h-full">
                    ...
                    {checkoutMode ? (
                        ...
                        <>
                            ...
                            {items.length > 0 && (
                                <div
                                    className="border-t border-[#EFE6D6] px-6 py-6 bg-[#FAF7F2]"
                                ...
                                >
                                    <div className="space-y-2 text-sm">
                                        ...
                                        <div className="pt-2 mt-2 border-t border-[#EFE6D6] flex items-baseline justify-between">
                                            <span className="font-serif-display text-2xl text-[#2E2825]">
                                                Total
                                            </span>
                                            <span
...
const Row = ({ label, value, testId }) => (
    <div className="flex items-center justify-between">
        ...
        <span
            className="font-semibold text-[#2E2825]"
            data-testid={testId}
        >
            {value}
        </span>
...
const EmptyState = ({ onClose }) => (
    <div className="flex flex-col items-center justify-center h-full py-12 text-center">
        ...
        <h3 className="font-serif-display text-2xl text-[#2E2825]">
