        ...
        >
            <div className="px-6 pt-2 pb-6">
                ...
                <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div
                        className="mt-6 clay-card-cream p-5 space-y-2 text-sm"
                    ...
                    >
                        ...
                        <div className="pt-2 border-t border-[#E6D9BF] flex items-baseline justify-between">
                            ...
                            <span
                                className="font-serif-display text-2xl font-semibold text-[#8B2956]"
...
const SectionTitle = ({ children }) => (
    <h4 className="font-serif-display text-lg text-[#8B2956] pt-2">
        {children}
    </h4>
);
...
const Field = ({ label, value, onChange, type = "text", testId, autoComplete }) => (
    <label className="block">
        <span className="text-xs uppercase tracking-widest text-[#2E2825]/60 ml-3">
            {label}
        </span>
        <input
