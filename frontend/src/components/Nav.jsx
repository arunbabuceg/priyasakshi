                ...
                >
                    ...
                    >
                        ...
                        <div className="hidden sm:block text-left leading-tight">
                            <div className="font-serif-display text-[#8B2956] text-lg font-semibold">
                                Lakshmi Sakshi
                            </div>
                            <div className="text-[10px] tracking-[0.2em] uppercase text-[#2E2825]/60">
                                Sarees · Garden Glow
                            </div>
                        </div>
                    </button>
                        ...
                        >
                            ...
                            {count > 0 && (
                                <span
                                    ...
                                    style={{
                                        background:
                                            "linear-gradient(180deg, #DC8A76 0%, #8B2956 100%)",
                                        boxShadow:
