...
const ProductCard = ({ product, tone = "cream", index = 0, onOpen }) => {
    const { add } = useCart();
    ...
    // Alternate soft background pastels behind the product image
    const palettes = [
    ...
    return (
        ...
        >
            {product.tag && (
                <div
                    className="absolute top-4 right-4 z-10 clay-pill"
            ...
            <div
                ...
                style={{
                    background: pal.bg,
                    boxShadow:
                        "inset 0 8px 16px rgba(0,0,0,0.06), inset 0 -8px 16px rgba(255,255,255,0.35)",
                }}
            >
                <motion.img
                    src={product.image}
            ...
            <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-[#2E2825]/60 mt-1 line-clamp-2">
