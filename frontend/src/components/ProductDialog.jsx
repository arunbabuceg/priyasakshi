...
const ProductDialog = ({ product, open, onOpenChange }) => {
            ...
            >
                ...
                <div className="clay-card overflow-hidden">
                    <div className="grid md:grid-cols-2 gap-0">
                        <div
                            className="aspect-square md:aspect-auto p-6"
                            style={{ background: "#F3EBDC" }}
                        >
                            <div
                        ...
                        <div className="p-8 flex flex-col">
                            {product.tag && (
                                <span className="clay-pill self-start mb-4">
                                    {product.tag}
                                </span>
                            )}
                            <h2 className="font-serif-display text-4xl text-[#2E2825] leading-tight">
                                {product.name}
                            </h2>
                            <p className="text-sm text-[#2E2825]/70 mt-4 leading-relaxed">
                            ...
                            <div className="mt-6 flex items-baseline gap-2">
                                ...
                                <span className="text-xs uppercase tracking-widest text-[#2E2825]/50">
                                    INR
                                </span>
                            </div>
