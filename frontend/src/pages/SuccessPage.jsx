...
/**
 * SuccessPage — retained for future payment-provider integration. Online
 * payments are disabled today, so we present a friendly "coming soon"
 * message rather than polling a checkout status.
 */
    ...
    >
      ...
      >
        ...
        <p className="mt-4 text-[#2E2825]/75 leading-relaxed">
          Online payments will be available soon. Your basket is safe — we’ll email you the
