                ...
                <div className="grid lg:grid-cols-12 gap-10 items-start">
                    ...
                    >
                        ...
                        <h2 className="mt-4 font-serif-display text-4xl sm:text-5xl text-[#2E2825] leading-tight">
                            Every drop —
                            <br />
                            <em className="italic text-[#8A9A5B]">
                                a garden.
                            </em>
                        </h2>
                        <p className="mt-6 text-base text-[#2E2825]/75 leading-relaxed">
                            Our Tamarai Hair Oil is cold-infused with{" "}
                            <span className="font-semibold text-[#8B2956]">
                                {items.length || 103}
                            </span>{" "}
                            sun-dried herbs — flowers, roots, leaves and seeds —
                            gathered from our garden and the wild groves of
                            Tamil Nadu.
                        </p>
                        <div className="mt-6 flex gap-3">
                            <div
                                className="clay-card-cream px-5 py-3 flex items-center gap-2"
                                data-testid="ingredients-count"
                            >
                                <Leaf className="w-4 h-4 text-[#8A9A5B]" />
                                <span className="font-serif-display text-xl text-[#8B2956]">
                                    {items.length || 103}
                                </span>
                                <span className="text-xs uppercase tracking-widest text-[#2E2825]/60">
                                    herbs
                                </span>
                            </div>
                    ...
                    >
                        <div
                            ...
                            data-testid="ingredients-list-card"
                        >
